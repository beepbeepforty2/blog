...
## Where LLMs are usable — but only inside machinery {#where-llms-are-usable--but-only-inside-machinery}
...
## Where LLMs are structurally unsuitable — no prompt fixes this {#where-llms-are-structurally-unsuitable--no-prompt-fixes-this}
